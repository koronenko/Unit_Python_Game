...
class StickFigureSprite(Sprite):    # анимация изображения героя
    def __init__(self, game):   #
        ...
        self.image = game.canvas.create_image(200, 833, image=self.images_left[0], anchor='nw') #
        self.x = -2     # величині на которіе смещаем фигурку по горизонтали, при старте фигурка сдвинется влево
...
platform1 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 50, 833, 120, 31)    # 9 создаем платформу 1 и ее позицию
#platform2 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 280, 680, 120, 31)      #   8
#platform3 = PlatformSprite(g, PhotoImage(file="platform1.gif"), 300, 650, 120, 31)      #
